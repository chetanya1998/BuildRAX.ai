...
| Day 11 / F01 — Predictable canvas interactions | Pending until merged; application and full Chromium checks passed | Not deployed | Internal editor work on `feat/f01-canvas-interaction-states` | [Day 11 canvas interaction states](DAY-11-CANVAS-INTERACTION-STATES.md) |
