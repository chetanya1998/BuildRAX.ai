...
export const templates: DiagramTemplate[] = [
  template(
    ...
    "Product",
    [
      createNode("user", "saas-user", "Workspace member", 20, 180),
      createNode("dns", "saas-dns", "Managed DNS", 20, 0),
      createNode("browser", "saas-browser", "Customer browser", 300, 180),
      createNode("cdn", "saas-cdn", "Edge CDN", 300, 0),
      createNode("api-gateway", "saas-gateway", "API gateway", 580, 180),
      createNode("identity-provider", "saas-idp", "Identity provider", 580, 380),
      createNode("backend-service", "saas-service", "Tenant service", 860, 120),
      createNode("secrets-manager", "saas-secrets", "Secrets manager", 860, -80),
      createNode("queue", "saas-queue", "Job queue", 860, 380),
      createNode("cache", "saas-cache", "Session cache", 1140, -40),
      createNode("relational-database", "saas-db", "Tenant database", 1140, 160),
      createNode("serverless-function", "saas-worker", "Background worker", 1140, 380),
      createNode("object-storage", "saas-storage", "Object storage", 1420, 0),
      createNode("observability", "saas-obs", "Observability", 1420, 220),
      createNode("repository", "saas-repo", "Source repository", 1420, 420),
    ],
    [
      createConnector("s1", "saas-user", "saas-idp", "control-plane", "Starts authenticated session"),
      createConnector("s2", "saas-browser", "saas-dns", "control-plane", "Resolve domain"),
      createConnector("s3", "saas-dns", "saas-cdn", "http-rest", "Edge route"),
      createConnector("s4", "saas-cdn", "saas-gateway", "http-rest", "HTTPS"),
      createConnector("s5", "saas-browser", "saas-idp", "http-rest", "OIDC"),
      createConnector("s6", "saas-gateway", "saas-idp", "control-plane", "Verify token"),
      createConnector("s7", "saas-gateway", "saas-service", "http-rest", "Authenticated API"),
      createConnector("s8", "saas-service", "saas-cache", "cache", "Session and hot data"),
      createConnector("s9", "saas-service", "saas-db", "database-read-write", "Tenant-scoped SQL"),
      createConnector("s10", "saas-service", "saas-queue", "async-message", "Background jobs"),
      createConnector("s11", "saas-queue", "saas-worker", "async-message", "Leased work"),
      createConnector("s12", "saas-worker", "saas-db", "database-read-write", "Durable results"),
      createConnector("s13", "saas-worker", "saas-storage", "object-transfer", "Generated assets"),
      createConnector("s14", "saas-service", "saas-secrets", "control-plane", "Runtime secrets"),
      createConnector("s15", "saas-service", "saas-obs", "event-stream", "Metrics and traces"),
      createConnector("s16", "saas-worker", "saas-obs", "event-stream", "Job telemetry"),
      createConnector("s17", "saas-repo", "saas-service", "control-plane", "Deployment source"),
    ],
  ),
  template(
    "ai-rag",
