...
export async function readArchitectureVersion(
  ...
  if (traceabilityResult.error?.code === "42501") throw new HttpError(403, "Diagram not found or access denied.");
  if (traceabilityResult.error) throw new HttpError(500, "Architecture traceability could not be read.");
