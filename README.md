...
| `GENERATION_QUEUE_CAPACITY` | Server | Shared queued/running job ceiling; defaults to `100`. |
| `GENERATION_PROVIDER_CONCURRENCY` | Server | Shared provider lease ceiling; defaults to `4`. |
| `GENERATION_PROVIDER_COST_CAPACITY` | Server | Reserved provider cost-unit ceiling; defaults to `100`. |
...
12. `202609200012_generation_jobs_and_admission.sql`
